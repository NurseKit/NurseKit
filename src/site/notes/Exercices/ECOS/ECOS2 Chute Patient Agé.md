...
> [!tips]- Indice : 2 Questions pour induire la réflexion
> 
> 1. Quel signe clinique est évocateur de **fracture du col du fémur** ?
> 2. Quelles **autres complications potentielles** devez-vous évaluer en urgence ?
> 
...
> - **État neurologique** → [[Médicaments/Normes/Glasgow\|Glasgow]], orientation, **confusion aiguë** ? (syndrome confusionnel fréquent post-traumatique chez la personne âgée).
> - **[[Pathologies/Traumatisme crânien\|Traumatisme crânien]]** → a-t-elle heurté la tête ? Douleur crânienne, perte de connaissance initiale ? **Surtout sous [[Médicaments/Anticoagulants/Rivaroxaban\|Rivaroxaban]]** (anticoagulant → risque **hémorragie intracrânienne**).
...
>  
> > [!warning] Avant de relever la patiente
...
>
> 1. **Alerter le médecin immédiatement** → suspicion de **fracture du col fémoral**, patient sous anticoagulant (Rivaroxaban) → Dernière prise du traitement ? + **Fragilité liée à l’âge**.
> 2. **Ne pas mobiliser seule** → attendre le médecin avant de relever, **sauf urgence vitale** (froid, inconfort extrême → couvrir avec une couverture en attendant).
> 3. **Antalgie** → signaler la douleur (EN 6/10) au médecin pour prescription d’antalgique (**paracétamol IV ou PO**), **ne pas administrer d’AINS** (insuffisance rénale fréquente chez le sujet âgé + interaction avec Rivaroxaban).
> 4. **Rassurer et installer confortablement** → couverture, parler calmement, **ne pas laisser seule**.
> 5. **Ne donner rien à boire ni à manger** (**mise à jeun préventive** → probable chirurgie).
> 6. **Informer l’équipe, noter l’heure de découverte et les circonstances**.
...
>[!Tips]- : 3 Questions pour induire la réflexion :
>
>1. Pourquoi le **groupe-RAI** est-il demandé ?
>2. Pourquoi vérifier la **dernière prise de Rivaroxaban** ?
>3. Quel est le **délai chirurgical recommandé** pour une fracture du col fémoral chez la personne âgée ?
...
> 
> - _Qu’est-ce que c’est ?_ : Imagerie pour visualiser une éventuelle **fracture**.
> - _Pourquoi ?_ :
...
> 
> - _Qu’est-ce que c’est ?_ : Analyses pour évaluer l’état général et préparer une éventuelle **chirurgie**.
> - _Pourquoi ?_ :
...
>
> **Traçabilité anticoagulant : dernière prise de [[Médicaments/Anticoagulants/Rivaroxaban\|Rivaroxaban]] ?**
> 
> - _Qu’est-ce que c’est ?_ : Vérification du **délai depuis la dernière prise** d’anticoagulant.
> - _Pourquoi ?_ :
...
> 
> - _Qu’est-ce que c’est ?_ : Consultation spécialisée pour **décision thérapeutique** (ostéosynthèse ou prothèse).
> - _Pourquoi ?_ :
...
> 
> - _Qu’est-ce que c’est ?_ : Apport hydrique et électrolytique.
> - _Pourquoi ?_ :
...
> [!success]- Correction des questions de rélfexion
>
> **1. Groupe-RAI :**
...
> - Le [[Médicaments/Anticoagulants/Rivaroxaban\|Rivaroxaban]] est un **anticoagulant oral (AOD anti-Xa)** sans antidote facilement accessible (andexanet alfa, coûteux et peu disponible).
...
---
> [!example]- Correction Transmission DAR - Cible : Chute avec suspicion de fracture du col fémoral
>
> **D :** Mme Girard, 82 ans, connue pour [[Fibri\|fibrillation auriculaire]] sous [[Médicaments/Anticoagulants/Rivaroxaban\|Rivaroxaban]], [[démence légère\|démence légère]], [[ostéoporose\|ostéoporose]]. Découverte au sol à 14h15, consciente, [[Médicaments/Normes/Glasgow\|Glasgow]] 15, douleur hanche droite **EN 6/10**. Jambe **raccourcie en rotation externe**. Pas de [[traumatisme crânien TC\|traumatisme crânien TC]] clinique. Dernière prise de [[Médicaments/Anticoagulants/Rivaroxaban\|Rivaroxaban]] : ce matin à 8h avec le petit-déjeuner.
>
> **A :** Médecin alerté à 14h20. Patiente **non mobilisée**. Antalgie (Paracétamol 1g PO) sur prescription. Bilan sanguin prélevé + **groupe-RAI**, radio hanche réalisée. **Mise à jeun** instaurée. Perfusion NaCl 0,9 % 500 mL démarrée. [[Médicaments/Anticoagulants/Rivaroxaban\|Rivaroxaban]] **suspendu ce soir** sur prescription. Déclaration d’événement indésirable rédigée.
>
...
---
> [!warning] Facteurs de risque identifiés chez Mme Girard
...
- **Traitement anticoagulant ([[Médicaments/Anticoagulants/Rivaroxaban\|Rivaroxaban]])** → Surveillance +++ des traumatismes, même mineurs
- **Troubles cognitifs ([[démence légère\|démence légère]])** → Environnement sécurisé, lit en position basse
- **Hypotension orthostatique possible** (TA 108/65) → Lever progressif, bas de contention
- **Médicament hypotenseur** (Lercanidipine, [[Médicaments/Bêta-bloquants/Bisoprolol\|Bisoprolol]]) → Réévaluer l’ordonnance avec le médecin
...
2. **Anticoagulant + traumatisme crânien = urgence même sans signe** → **scanner cérébral** à discuter systématiquement.

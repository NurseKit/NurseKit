...
À 16h20, M. Lecomte appuie sur la sonnette : _"J'ai chaud, j'ai la chair de poule et je commence à grelotter."_

---

## Phase 1 - Reconnaître et agir (3 premières minutes)

À votre arrivée dans la chambre à 16h22, vous constatez : M. Lecomte agité, frissons visibles, T° 38,7°C (+1,6°C par rapport à T0), FC 104 bpm, TA 128/74 mmHg, SpO2 96 %. Pas d'urticaire, pas d'œdème, pas de dyspnée. Il dit : _"J'ai mal dans le dos aussi, là..."_
...
>     
> 5. **Conserver la poche et la tubulure** - elles seront renvoyées au laboratoire et à l'EFS pour analyse.
>     
> 6. **Ne PAS jeter** les tubes de prélèvement pré-transfusionnels (si encore disponibles).
>     
> 
> > [!danger] Ne jamais reprendre la transfusion sans avis médical écrit Même si les symptômes semblent s'améliorer. La décision de reprendre appartient au médecin après bilan.

---

## Phase 2 - Identifier le type de réaction

Le médecin est arrivé. Il vous demande : _"Selon vous, de quel type de réaction s'agit-il ?"_
...
> 2. Comment effectuez-vous le retour de la poche à l'EFS ?
...
>- _Qu'est-ce que c'est ?_ : Ensemble d'analyses pour évaluer l'état général et rechercher une hémolyse.
...
>
>- _Qu'est-ce que c'est ?_ : Envoi de la poche et de la tubulure à l'Établissement Français du Sang pour contrôle bactériologique et immunologique.
>
>- _Pourquoi ?_ :
...
>
>- _Qu'est-ce que c'est ?_ : Antipyrétique et antalgique de palier 1, administré en IV lente.
>
>- _Pourquoi ?_ :
...
>
>- _Qu'est-ce que c'est ?_ : Obligation réglementaire de signalement de toute réaction indésirable receveur (RIR).
>  
>- _Pourquoi ?_ :
...
> [!success]- Correction des 3 questions de réflexions
> 
...
> 
> 1. **Contrôles ultimes pré-transfusionnels** (obligatoires avant de brancher la nouvelle poche) :
...
<div class="nursekit-nav" style="display:flex;gap:10px;margin-top:2.5rem;padding-top:1.5rem;border-top:1px solid rgba(99,102,241,0.2);"> <a href="/" style="flex:1;display:block;text-align:center;padding:10px 16px;background:#6366F1;color:white;border-radius:8px;text-decoration:none;font-size:13px;font-weight:500;">← Accueil</a> <a href="#" style="flex:1;display:block;text-align:center;padding:10px 16px;background:rgba(99,102,241,0.08);color:#6366F1;border-radius:8px;text-decoration:none;font-size:13px;font-weight:500;border:1px solid rgba(99,102,241,0.25);">↑ Haut de page</a> </div>
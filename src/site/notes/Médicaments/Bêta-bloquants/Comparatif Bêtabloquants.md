---
{"dg-publish":true,"permalink":"/medicaments/beta-bloquants/comparatif-betabloquants/","tags":["bêtabloquant","comparatif","cardiologie","révision"],"noteIcon":"","dg-note-properties":{"nom":"Comparatif des bêtabloquants","type":"Tableau comparatif","tags":["bêtabloquant","comparatif","cardiologie","révision"],"revision":"2026-06-24"}}
---
...
|----------|------------------|----------------------|---------------|
| **Bisoprolol** ([[Cardensiel\|Cardensiel]]®, [[Détensiel\|Détensiel]]®) | +++ | IC, HTA, FA | Le plus sélectif → 1er choix en IC |
| **Métoprolol** ([[Lopressor\|Lopressor]]®, [[Seloken\|Seloken]]®) | ++ | HTA, IDM, IC | Forme LP disponible |
| **Aténolol** | ++ | HTA | Éliminé par voie rénale (adapter si IRC) |
| **Nébivolol** ([[Temerit\|Temerit]]®) | +++ + vasodilatation | HTA, IC sujet âgé | Vasodilatation via NO |
| **Propranolol** ([[Avlocardyl\|Avlocardyl]]®) | Non sélectif | HTA, tremblement, anxiété, migraine, hyperthyroïdie | CI asthme/BPCO · Passe la barrière hémato-encéphalique |
| **Carvédilol** ([[Kredex\|Kredex]]®) | Non sélectif + α-bloquant | IC, HTA sévère | Double blocage → vasodilatation périphérique |
| **Labetalol** | Non sélectif + α-bloquant | HTA urgence (IV) / HTA grossesse | Utilisé en IV pour les urgences hypertensives |
| **Esmolol** ([[Brévibloc\|Brévibloc]]®) | β1 sélectif | Urgence : FA, flutter, tachycardie per-opératoire | Demi-vie ultra-courte (9 min) → IVSE uniquement |

---

## Contre-indications communes

> [!danger] CI absolues (tous les bêtabloquants)
...
> [!warning] Attention en pratique IDE
...
[[Médicaments/Bêta-bloquants/Bisoprolol\|Bisoprolol]] · [[Médicaments/Anticoagulants/Comparatif Anticoagulants\|Anticoagulants]] · [[Pathologies/Fibrillation atriale\|FA]] · [[Pathologies/Insuffisance cardiaque\|Insuffisance cardiaque]]

> [!caution] Outil pédagogique : ESC Guidelines, ANSM

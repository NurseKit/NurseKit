...
| Section | Fiches | Contenu |
|---------|--------|---------|
| [[Cas Cliniques\|Cas Cliniques]] | 20 | Cas IFSI complets (situation + solution masquée) + transmissions ciblées |
| [[Pharmacologie\|Pharmacologie]] | 7 | Interactions, sécurité, antibio, paliers OMS, NEWS2 |
| [[Calculs Doses\|Calculs Doses]] | 5 | Exercices avec corrigés masqués (débit, dilution, pédiatrie, SE) |
...
> - QCM par thème → tester ses connaissances
> - Fiches pathologies → réviser les points clés
> - Cas cliniques → s'entraîner aux examens IFSI

> [!tip] Pour les stages
> - Fiches de service → checklist par spécialité
> - Médicaments → vérification rapide avant administration
> - Soins infirmiers → rappel des techniques

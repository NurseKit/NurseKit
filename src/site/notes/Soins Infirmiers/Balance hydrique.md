---
{"dg-publish":true,"permalink":"/soins-infirmiers/balance-hydrique/","tags":["soin-infirmier","réanimation","balance-hydrique","diurèse","surveillance"],"noteIcon":"","dg-note-properties":{"nom":"Balance Hydrique - Bilan Entrées/Sorties","classe":["Soin infirmier"],"type":"Surveillance et calcul","systeme":"Réanimation / Tous services","tags":["soin-infirmier","réanimation","balance-hydrique","diurèse","surveillance"],"revision":"2026-06-14"}}
---
...
- [ ] **Ouvrir le tableau de balance à l'admission** et le renseigner en temps réel
- [ ] **Diurèse horaire** : noter toutes les heures la diurèse via poche urinaire graduée → alerte si < 0,5 mL/kg/h
- [ ] Mesurer et noter **tout** ce qui sort (drains, SNG, vomissements)
- [ ] Comptabiliser **toutes** les entrées y compris les petits volumes (flush de 10 mL, diluants des médicaments)
- [ ] Calculer et noter le **bilan intermédiaire** toutes les 6 h
- [ ] Calculer le **bilan des 24 h** à la relève du matin (ou selon le protocole du service)
- [ ] Signaler au médecin :
...
- [ ] Peser le patient tous les jours à la même heure si possible (balance la plus fiable)
- [ ] Tracer dans le dossier de soins

## Points de vigilance

> [!danger] Anurie = urgence
...
> [!warning] Ne pas oublier les petits volumes
...
[[Pathologies/Insuffisance rénale aigue\|IRA]] · [[Sonde urinaire\|Sonde urinaire]] · [[Pathologies/OAP\|OAP]] · [[Pathologies/Sepsis\|Sepsis]]

> [!caution] Outil pédagogique : Toujours vérifier les objectifs de balance prescrits par le médecin

---
{"dg-publish":true,"permalink":"/soins-infirmiers/acr/","tags":["urgence","ACR","RCP","défibrillation","urgence-vitale"],"noteIcon":"","dg-note-properties":{"nom":"Arrêt Cardio-Respiratoire - Conduite à Tenir IDE","classe":["Situation d'urgence"],"type":"Protocole d'urgence","systeme":"Urgences / Réanimation","tags":["urgence","ACR","RCP","défibrillation","urgence-vitale"],"revision":"2026-06-14"}}
---
...
> [!danger] URGENCE ABSOLUE. Chaque minute sans RCP = 10% de chances de survie en moins
...
1. **Crier "À L'AIDE !"** et demander le chariot d'urgence + défibrillateur
2. Appeler le **15 (SAMU)** ou le **numéro interne de réanimation** selon le service
3. Chronomètre → noter l'heure de découverte
...
| [[Médicaments/Antiarythmiques/Amiodarone\|Amiodarone]] | 300 mg IVD | Après 3e choc si FV/TV sans pouls réfractaire |
| Bicarbonate 8,4% | 1 mEq/kg | Si ACR > 10 min ou hyperkaliémie connue (sur prescription) |

## Ne pas faire

> [!danger] Ne jamais interrompre le MCE pour vérifier le pouls ou l'ECG
...
> [!warning] Ne pas ventiler en excès
> 2 insufflations en 1 sec chacune → trop insuffler = distension gastrique → régurgitation → inhalation.

## Les 3 choses à retenir

1. **MCE 30:2 immédiat** → ne pas attendre le médecin pour commencer
2. **DEA dès disponible** → brancher et suivre les instructions vocales
3. **Adrénaline 1 mg / 3-5 min** dès que la voie veineuse est posée (sur prescription)

## Voir aussi

[[Pathologies/ACR & RCP\|ACR/RCP (pathologie)]] · [[Médicaments/Vasopresseurs/Adrenaline\|Adrénaline]] · [[Soins Infirmiers/Détresse respiratoire aigue\|Détresse respiratoire]]

> [!caution] Outil pédagogique : Guidelines ERC 2021. Formation aux gestes = AFGSU obligatoire

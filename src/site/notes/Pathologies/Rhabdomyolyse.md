---
{"dg-publish":true,"permalink":"/Pathologies/Rhabdomyolyse/","tags":["pathologie","rénal","urgence","traumatologie","réanimation"],"noteIcon":"","dg-note-properties":{"nom":"Rhabdomyolyse","systeme":"Rénal / Traumatologie","tags":["pathologie","rénal","urgence","traumatologie","réanimation"],"revision":"2026-06-22"}}
---
...
- [ ] Surveillance horaire de la diurèse (objectif > 200-300 mL/h pendant la phase de traitement)
- [ ] Hyperhydratation IV massive sur prescription : NaCl 0,9 % ou sérum bicarbonaté 1,4 % (alcalinisation → prévient la précipitation de myoglobine) : souvent 1 L/h en phase aiguë
- [ ] Bilans biologiques : CPK (x4-6h), créatinine, ionogramme (K⁺ ↑), bilan hépatique, NFS, coagulation (risque de CIVD)
- [ ] Surveiller les signes de syndrome des loges : douleur intense à l'étirement passif, tension cutanée, paresthésies → urgence chirurgicale (fasciotomie)
- [ ] Surveillance ECG si hyperkaliémie (K⁺ > 5,5) : ondes T pointues, QRS élargis → traitement urgent
- [ ] Éviter les AINS et les néphrotoxiques (aggravent l'IRA)
- [ ] Surveiller les complications : IRA oligoanurique (dialyse possible), hyperkaliémie, hypocalcémie, CIVD

## Points de vigilance

> [!danger] Syndrome des loges
...
> [!danger] Hyperkaliémie sur rhabdomyolyse
